...
<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
    <li><a tabindex="-1" href="#" data-subtype="bgmusic" value="mu">Music</a></li>
    <li><a tabindex="-1" href="#" data-subtype="soundeffect" value="se">Sound Effect</a></li>
    <li><a tabindex="-1" href="#" data-subtype="voiceover" value="vo">Voice-Over</a></li>
</ul>
</div>
</script>
...
<a class="import-as-btn dropdown-toggle" data-toggle="dropdown" href="#">Import as <span class="caret"></span></a>
<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
    <li><a tabindex="-1" href="#" data-subtype="prop" value="prop">Prop</a></li>
    <li><a tabindex="-1" href="#" data-subtype="background" value="bg">Backdrop</a></li>
</ul>
</div>
</script>
